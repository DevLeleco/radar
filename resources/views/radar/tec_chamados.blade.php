...
<div class="jumbotron py-1">
	<div class="container text-center">
		<h1 class="display-4">Chamados Abertos e em Andamento</h1>		
            ...
            @foreach($chamados as $chamado) 
              <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('rt.view_chamados', $chamado->id_chamado)}}" name='btn-close' class="btn btn-success btn_close"><i class="fas fa-door-closed"></i></a> 
                  </td>                  
              </tr>
            @endforeach   
          @endif
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <label for="exampleInputPassword1">Observação</label>
			      <textarea class="form-control"  rows="2" name="edit_observacao" id="edit_observacao" disabled></textarea>
